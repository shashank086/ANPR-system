#!/usr/bin/env python3
"""
Test script for improved license plate detection
"""
...
def test_detection():
    ...
    try:
        ...
        cv2.imwrite("test_plate.png", test_image)
        ...
        plates = detector.detect_plates_traditional(test_image)
        print(f"Traditional CV found {len(plates)} potential plates")
